...
Requirements:
- Run `sh "$HOME/.config/opencode/skills/context-task-planning/scripts/validate-task.sh"` from the current workspace.
...
```bash
sh "$HOME/.config/opencode/skills/context-task-planning/scripts/validate-task.sh"
```
