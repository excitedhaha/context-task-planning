...
Requirements:
- Run `sh "$HOME/.config/opencode/skills/context-task-planning/scripts/list-tasks.sh"` from the current workspace.
...
```bash
sh "$HOME/.config/opencode/skills/context-task-planning/scripts/list-tasks.sh"
```
