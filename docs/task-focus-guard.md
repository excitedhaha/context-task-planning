...
| Codex | `current-task.sh` in shell or tmux now | best-effort reminder through skill text and future metadata | none in P0 | shared core + skill-level policy | medium-low |
